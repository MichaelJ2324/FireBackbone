(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['underscore', 'backbone', 'exports'], function(_, Backbone, exports) {
            ...
            root.FirebaseBackbone = factory(root, exports, _, Backbone);
        });
        ...
        root.FirebaseBackbone = factory(root, {}, root._, root.Backbone);
    }

})(function(root, FirebaseBackbone, _,Backbone) {
    ...
    var previousFirebaseBackbone = root.FirebaseBackbone;

    //VERSION
    FirebaseBackbone.VERSION = '1.0';

    // Runs FirebaseBackbone.js in *noConflict* mode, returning the `FirebaseBackbone` variable
    // to its previous owner. Returns a reference to this Backbone object.
    FirebaseBackbone.noConflict = function() {
        root.FirebaseBackbone = previousFirebaseBackbone;
        return this;
    };
    ...
    var _determineDatabase = function (model, options) {
        var proto = Object.getPrototypeOf(model);
        return _.extend({
                database: proto.hasOwnProperty('database') ? proto.database : null
            },
            this,
            options
        ).database;
     ...
     */
    FirebaseBackbone.sync = function (method, model, options) {
    ...
    var Model = FirebaseBackbone.Model = Backbone.Model.extend({
        ...
        initialize: function (model, options) {
            ...
            this._autoSync = _determineAutoSync(this, options);
        ...
        _configureRef: function(){
            if (this.autoSync()){
                this._ref.on('value',this._setLocal,function(err){
                    this.trigger('FirebaseBackbone:error',this,err,'value');
                },this);
            }
        },
        ...
        sync: function (method, model, options) {
            FirebaseBackbone.sync(method, model, options);
        },
                ...
                if (this.autoSync()){
                    if (options.reset || _.isNull(this._ref)) {
                        ...
                        this._ref.on('child_added',this._childAdded,function(err){
                            this.trigger("FirebaseBackbone:error",this,err,'child_added');
                        },this);
                        this._ref.on('child_moved',this._childMoved,function(err){
                            this.trigger("FirebaseBackbone:error",this,err,'child_moved');
                        },this);
                        this._ref.on('child_changed',this._childChanged,function(err){
                            this.trigger("FirebaseBackbone:error",this,err,'child_changed');
                        },this);
                        this._ref.on('child_removed',this._childRemoved,function(err){
                            this.trigger("FirebaseBackbone:error",this,err,'child_removed');
                        },this);
                    }
                }
    ...
    FirebaseBackbone.Collection = Backbone.Collection.extend({
